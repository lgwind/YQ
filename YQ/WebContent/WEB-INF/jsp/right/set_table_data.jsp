...
<%
	...
	List<Data> dataList = new DataDao().getAll();
%>
<div class='record-title2'>用户信息表管理
</div>
...
<%--     <tr><th class='record-title2' colspan='2'><%=usernameLgwind %>的考勤记录</th></tr> --%>
    <%
      for(int i=0;i<dataList.size();i++){ %>
        <tr><td onclick='window.open("#message-<%=dataList.get(i).getUsername() %>","_self")'><%=dataList.get(i).getUsername() %></td></tr>
    <%}%>
    </table>
</div>
