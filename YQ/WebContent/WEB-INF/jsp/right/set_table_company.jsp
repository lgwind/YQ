...
<%
	...
	List<Company> companyList = new CompanyDao().getAll();
%>
<div class='record-title2'>企业信息表管理
</div>
...
<%--     <tr><th class='record-title2' colspan='2'><%=usernameLgwind %>的考勤记录</th></tr> --%>
    <%
      for(int i=0;i<companyList.size();i++){ %>
        <tr><td onclick='window.open("#message-<%=companyList.get(i).getCompanyName() %>","_self")'><%=companyList.get(i).getCompanyName() %></td></tr>
    <%}%>
    </table>
</div>
