...
%>
<div class="me-left">
    <div onclick='window.open("${pageContext.request.contextPath }/page/me/login","_self")'>
	...
	<ul class='left-ul'>
		...
		<li class='menu' 
			onclick='window.open("${pageContext.request.contextPath }/page/me/messagePerson","_self")'>
			个人信息
		</li>
		<li class='menu' 
			onclick='window.open("${pageContext.request.contextPath }/page/me/passwordUpdate","_self")'>
			密码修改
		</li>
		<li class='menu' 
			onclick='window.open("${pageContext.request.contextPath }/page/me/login","_self")'>
			帮助
		</li>		
		<li class='menu' 
			onclick='window.open("${pageContext.request.contextPath }/user/loginExit","_self")'>
			退出
		</li>
		<%}%>
	</ul>
